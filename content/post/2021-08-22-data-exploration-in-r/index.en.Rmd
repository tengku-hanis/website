...
This is the output exampple in [pdf](dataMaid_heartfailure.pdf).
...
Lastly, from dlookr we can get the overall report of the data exploration in pdf (and other formats as well). This report is quite comprehensive, have a [look](EDA_Paged_Report.pdf). 
```{r, eval=FALSE}
heartfailure %>% 
