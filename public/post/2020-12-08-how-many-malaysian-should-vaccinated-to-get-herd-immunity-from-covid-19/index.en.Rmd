...
The basic idea of R~0~ or basic reproduction number is quite simple. It describes how many secondary infection will derive from the first case. I think figure below describe this idea very well.

```{r, echo=FALSE, out.width='60%', fig.align='center', fig.cap="Source image:https://www.atrainceu.com/content/3-basic-reproduction-number-r-naught"}
...
*Disclaimer: This is just my opinion. Please take with a huge grain of salt*
